...
def predictint(imvalue):
    ...
    with tf.Session() as sess:
        sess.run(init_op)
        saver.restore(sess, "D:/Downloads/tensorflow-mnist-predict-master/tensorflow-mnist-predict-master/model.ckpt")
...
def imageprepare(argv):
    ...
    #newImage.save("D:/Downloads/tensorflow-mnist-predict-master/tensorflow-mnist-predict-master/sample.png")
